...
let notifIcon = `
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" class="datatable-notifIcon-therapist">
    ...
    return $(".table").DataTable({
        ...
        rowCallback: function (row, data, nColumn) {
            if (data[5].replace(/(<([^>]+)>)/gi, "") == "Menunggu") {
                ...
                $('td:eq(0)', row).find(".datatable-notifIcon-therapist").remove();

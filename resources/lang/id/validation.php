...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'confirmed' => 'Konfirmasi password tidak cocok dengan kolom password.',
            'required_with' => 'Kolom :attribute wajib untuk diisi jika kolom konfirmasi password diisi.'
        ],
        'marital_status' => [
            'required' => 'Kolom pilih status kawin wajib untuk dipilih.'
        ],
        'job' => [
            'required' => 'Kolom pekerjaan wajib untuk dipilih.'
        ],
        'source' => [
            'required' => 'Kolom sumber informasi wajib untuk dipilih.'
        ],
        'gender' => [
            'required' => 'Jenis kelamin wajib untuk dipilih.'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'name_user'             => 'nama pengelola',
        'name_customer'         => 'nama pelanggan',
        'whatsapp_number'       => 'nomor whatsapp',
        'job'                   => 'pekerjaan',
        'alternative_number'     => 'telepon alternatif',
    ],
];

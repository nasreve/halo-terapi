<div class="tbr_member_aside">
    <ul class="tbr_member_menu">
        <li class="tbr_member_nav_history_order">
            <a href="{{ route('patient.order.history') }}">
        ...
        <li class="tbr_member_nav_referral {{ $patient->referrer()->exists() && $patient->referrer->blocked === 0 ? "active" : "" }}">
            <a href="{{ $patient->referrer()->exists() ? route('patient.referral.dashboard') : route('patient.referral.confirmation') }}">
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 2" width="24" height="24" viewBox="0 0 24 24">
                    <g id="link-2">

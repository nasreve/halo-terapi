                    ...
                    <div class="tbr_box_list">
                        <div class="tbr_box_list_item">
                            ...
                            <div class="tbr_box_icon_desc">
                                ...
                                <span data-toggle="tooltip" data-placement="bottom" title="{{ $therapist->str_number }}"
                                    data-html="true">{{ Str::limit($therapist->str_number, 18, ' ...') ?? 'Data belum lengkap' }}</span>
                            </div>
                        </div>
                        <div class="tbr_box_list_item">
                            ...
                            <div class="tbr_box_icon_desc">
                                ...
                                <span data-toggle="tooltip" data-placement="bottom"
                                    ...
                                    data-html="true">{{ Str::limit('Kecamatan ' . $therapist->district->name, 18, ' ...') ?? 'Data belum lengkap' }}</span>
                            ...
                            <div class="tbr_box_icon_desc">
                                <a href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <span class="tbr_text-grey">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10.227" height="5.112"
                                            viewBox="0 0 10.227 5.112">
                                            <path id="Path_3" data-name="Path 3"
                                                d="M12.256,15.225a.73.73,0,0,1-.57-.27L8.159,10.573a.73.73,0,0,1,0-.928l3.652-4.382a.731.731,0,1,1,1.125.935L9.671,10.112l3.155,3.915a.73.73,0,0,1-.57,1.2Z"
                                                transform="translate(-5 13.105) rotate(-90)" fill="#7e8299" />
                                        </svg>
                                    </span>
                                </a>
                    ...
                    <ul class="nav nav-tabs tbr_nav_tabs justify-content-center mt-2" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="service-tab" data-toggle="tab" href="#service" role="tab"
                                aria-controls="service" aria-selected="true">Layanan</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="education-tab" data-toggle="tab" href="#education" role="tab"
                                aria-controls="education" aria-selected="false">Pendidikan</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="workshop-tab" data-toggle="tab" href="#workshop" role="tab"
                                aria-controls="workshop" aria-selected="false">Workshop</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="experience-tab" data-toggle="tab" href="#experience" role="tab"
                                aria-controls="experience" aria-selected="false">Pengalaman PKL</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="service" role="tabpanel"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-6 tbr_column">
                                        <div class="tbr_service_card">
                                            <input type="checkbox" id="service_{{ $service->id }}"
                                                name="service_{{ $service->id }}" value="{{ $service->id }}"
                                                value="1" class="d-none"
                                                {{ checkedOrderTherapist($service->id, $therapist->username) }}>
                                            <label for="service_{{ $service->id }}" class="radio"
                                                anim="ripple"></label>
                                            <div class="tbr_sc_check">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24.3"
                                                    height="18.245" viewBox="0 0 24.3 18.245">
                                                    <path id="Path_761" data-name="Path 761"
                                                        d="M12.878,24.2a1.515,1.515,0,0,1-1.106-.485L4.41,15.884a1.516,1.516,0,1,1,2.212-2.075l6.241,6.65L25.6,6.523a1.515,1.515,0,1,1,2.242,2.03L14,23.7a1.515,1.515,0,0,1-1.106.5Z"
                                                        transform="translate(-3.999 -5.956)" fill="#ddd" />
                                                </svg>
                                            </div>
                                            <h4>{{ $service->title }}</h4>
                                            <p>{{ Str::limit($service->description, 65, $end = '...') }}</p>
                                            <a href="" class="tbr_text-success d-block mb-2"
                                                data-toggle="modal"
                                                data-target="#modal-service-{{ $service->id }}"><em>Selengkapnya</em></a>
                                            <div class="mb-4 tbr_service_card_price">
                                                {{ formatPrice(getServiceDisplayPrice($therapist->id, $service->id)) }}
                                            </div>
                                            <div class="tbr_btn_group">
                                                <button type="button"
                                                    class="btn tbr_btn tbr_btn-success tbr_btn_order">Pesan</button>
                                                <button type="button"
                                                    class="btn tbr_btn tbr_btn-light-danger tbr_btn_cancel">Batalkan</button>
                                            </div>
                                        </div>

                                        @include('visitor.partials.modal-service-therapist', [
                                        'service' => $service,
                                        ])
                                    </div>
                                    @empty
                            ...
                            <nav aria-label="Page navigation" class="mt-3 mb-0 pt-2">
                                <ul class="pagination tbr_pagination m-auto justify-content-center">
                                    <li
                                        class="page-item {{ $paginatedData->currentPage() == 1 ? ' tbr_disabled' : '' }}">
                                        <a class="page-link"
                                            href="{{ route('therapist.profile', ['username' => request()->route('username'), 'page' => $paginatedData->currentPage() - 1]) }}">
                                            <img src="{{ asset('/assets/svg/icons/icon_paginate_prev.svg') }}"
                                                alt="Previous">
                                        </a>
                                    </li>
                                    @for ($i = 1; $i <= $paginatedData->lastPage(); $i++)
                                        <li
                                            class="page-item {{ $paginatedData->currentPage() == $i ? ' tbr_active' : '' }}">
                                            <a class="page-link"
                                                href="{{ route('therapist.profile', ['username' => request()->route('username'), 'page' => $i]) }}">{{ $i }}</a>
                                        </li>
                                        @endfor
                                        <li
                                            class="page-item {{ $paginatedData->currentPage() == $paginatedData->lastPage() ? ' tbr_disabled' : '' }}">
                                            <a class="page-link"
                                                href="{{ route('therapist.profile', ['username' => request()->route('username'), 'page' => $paginatedData->currentPage() + 1]) }}">
                                                <img src="{{ asset('/assets/svg/icons/icon_paginate_next.svg') }}"
                                                    alt="Next">
                                            </a>
                                        </li>
                                </ul>

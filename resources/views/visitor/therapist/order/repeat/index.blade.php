                            ...
                            <div class="tbr_therapist">
                                ...
                                <div class="tbr_therapist_detail">
                                    <div class="tbr_therapist_name">
                                        ...
                                        <span>{{ $order->therapist->str_number }}</span>
                                    </div>
                                    <div class="tbr_therapist_skill">
                                        @foreach ($order->therapist->services->take(4) as $service)
                                            {{ $service->title }}
            ...
            <div class="row">
                <div class="col">
                    <div class="tbr_wizard_nav">
                        <a href="{{ route('therapist.order.history') }}" anim="ripple" class="btn tbr_btn-outline tbr_btn-o-primary tbr_wizard_prev">
                            <i class="icons icon-arrow-left"></i> Sebelumnya
                        </a>
                        <button type="button" anim="ripple" class="btn tbr_btn tbr_btn-primary tbr_wizard_next" data-url="{{ route('therapist.order.replicate', $order->id) }}">
                            Konfirmasi
                        </button>
                    </div>
                </div>
...
@endsection
@section('blockfoot')
    <script src="{{ asset('assets/js/visitor/therapist/duplicate-order.js') }}"></script>
@endsection
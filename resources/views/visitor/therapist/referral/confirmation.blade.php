            ...
            <div class="tbr_member_content_body">
                ...
                <div class="text-center">
                    ...
                    @if (auth()->guard('therapist')->user()->status == 'Disetujui')
                        <a href="{{ route('therapist.referral.form') }}" anim="ripple" class="btn tbr_btn tbr_btn-primary d-inline-flex">Aktifkan akun referral sekarang</a>
                    @else
                        <div anim="ripple" class="btn tbr_btn tbr_btn-primary d-inline-flex tbr_disabled">Aktifkan akun referral sekarang</div>
                    @endif
                </div>
            </div>
        </div>

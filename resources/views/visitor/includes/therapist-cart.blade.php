            ...
            <div class="col">
                <div class="tbr_cart_wrap">
                    ...
                    <div class="tbr_cart_action">
                        ...
                        @else
                            <button type="button" anim="ripple" class="btn tbr_btn tbr_btn-danger d-none d-md-block" onclick="window.location.href = '/therapist/{{ request()->route('username') }}/order/step-2'">
                                <span class="mr-2">Selanjutnya</span>
                                <img src="{{ asset('/assets/svg/icons/icon_cart_next.svg') }}" alt="Selanjutnya">
                            </button>
                            <button type="button" anim="ripple" class="btn tbr_btn tbr_btn-danger tbr_btn-square d-flex d-md-none" onclick="window.location.href = '/therapist/{{ request()->route('username') }}/order/step-2'">
                                <span class="mr-2">Selanjutnya</span>
                                <img src="{{ asset('/assets/svg/icons/icon_cart_next.svg') }}" alt="Selanjutnya">
                            </button>
                        @endguest

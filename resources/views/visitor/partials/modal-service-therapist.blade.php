    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="tbr_modal_action text-right mt-4 pt-1">
                ...
                <button type="button" anim="ripple" class="btn tbr_btn tbr_btn-success tbr_btn-order-modal ml-2 {{ modalCheckOrderTherapist($service->id, $therapist->username) ? "d-none" : "" }}">Pesan Sekarang</button>
                <button type="button" anim="ripple" class="btn tbr_btn tbr_btn-light-danger tbr_btn-cancel-modal ml-2 {{ modalCheckOrderTherapist($service->id, $therapist->username) ? "" : "d-none" }}">Batalkan</button>
            </div>
        </div>
    </div>
</div>
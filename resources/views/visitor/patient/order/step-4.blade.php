...
@section('content')
    ...
    <div class="tbr_wizard_body">
        <div class="container">
            ...
            <form action="{{ route('order.step4submits') }}" method="POST" class="tbr_main_form">
                @csrf
                <div class="row justify-content-center no-gutters">
                    <div class="col-xl-8 col-lg-8 col-md-10 col-12">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>{{ \Illuminate\Support\Str::limit(session('step3data')->buyer_name, 22, ' ...') }}</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_block_list">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>{{ session('step3data')->buyer_age }} Tahun</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_block_list">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>{{ session('step3data')->buyer_gender }}</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_block_list">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>{{ session('step3data')->buyer_job }}</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12" id="ajax-replace">
                                <div class="tbr_block_list">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>62 {{ session('step3data')->buyer_phone }}</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_block_list">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>62 {{ session('step3data')->buyer_whatsapp }}</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_block_list">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="text-left text-md-right">
                                                <em>{{ session('step3data')->buyer_email }}</em>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_icon_box">
                                    ...
                                    <div class="tbr_icon_box_desc">
                                        ...
                                        <p>
                                            {{ session('step3data')->buyer_address }}, {{ session('step3data')->buyer_sub_district }}, Kecamatan {{ session('step3data')->buyer_district }},
                                            {{ session('step3data')->buyer_regency }}, Provinsi {{ session('step3data')->buyer_province }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="tbr_icon_box">
                                    ...
                                    <div class="tbr_icon_box_desc">
                                        ...
                                        <p>
                                            {{ session('step3data')->buyer_symptoms }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        ===========================================
                        --}}
                        @if (!session('choosenTherapists')->isEmpty())
                            {{-- Terapist --}}
                                    ...
                                    <div class="tbr_therapist">
                                        ...
                                        <div class="tbr_therapist_detail">
                                            <div class="tbr_therapist_name">
                                                ...
                                                <span>{{ $therapist->serial_number }}</span>
                                            </div>
                                            ...
                                            <div class="tbr_therapist_meta">
                                                <span>
                                                    <img src="{{ asset('/assets/svg/icons/icon_pin_map.svg') }}" alt="Location">&nbsp;
                                                    {{ getRegencyName($therapist->regency_id) }}
                                                </span>
                                                <span>
                                                    <span>{{ formatPrice($therapistServices[$index]->rate) }}</span>
                                        ...
                                        <a
                                            ...
                                            data-html="true"
                                            data-service="{{ $services[$index]->id }}"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-9 col-lg-9 col-md-10 col-12">
                                    <div class="tbr_info_box py-3 justify-content-center align-items-center">
                                        ...
                                        <div class="tbr_info_box_desc">
                                            @if (session('step3data')->buyer_payment_method === "Cash")
                            ...
                            <div class="row justify-content-center mt-4">
                                <div class="col-xl-9 col-lg-9 col-md-10 col-12">
                                    ...
                                    <div class="text-center mt-4 mb-4 pt-1 pb-2">
                                        <a href="{{ url('/') }}" anim="ripple" class="btn tbr_btn tbr_btn-primary btr_wizard_order_reset">
                                            Order Lagi
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="tbr_wizard_nav">
                            <a href="{{ route('order.step-3') }}" anim="ripple" class="btn tbr_btn-outline tbr_btn-o-primary tbr_wizard_prev">
                                <i class="icons icon-arrow-left"></i> Sebelumnya
                            </a>
                            <button type="submit" anim="ripple" class="btn tbr_btn tbr_btn-danger tbr_wizard_next">
                                Kirim
                            </button>
                        </div>
                    </div>
...
@endsection
@section('blockfoot')
    <script src="{{ asset('assets/js/visitor/submit-order.js') }}"></script>
    <script src="{{ asset('assets/js/visitor/step4-delete-data.js') }}"></script>
@endsection
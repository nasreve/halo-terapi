        ...
        <div class="container">
            ...
            <div class="row justify-content-center no-gutters">
                <div class="col-xl-8 col-lg-8 col-md-10 col-12">
                    <form action="{{ route('order.step3submits') }}" method="POST" class="step3form needs-validation" autocomplete="off">
                        @csrf
                        {{-- Personal Data --}}
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="buyer_name"
                                        name="buyer_name"
                                        value="{{ session('step3data')->buyer_name ?? auth()->guard('patient')->user()->name }}"
                                        placeholder=""
                                        tabindex=""
                                        spellcheck="false"
                                    >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input
                                            ...
                                            id="buyer_age"
                                            name="buyer_age"
                                            value="{{ session('step3data')->buyer_age ?? Carbon\Carbon::parse(auth()->guard('patient')->user()->date_of_birth)->age }}"
                                            placeholder=""
                                            tabindex=""
                                            spellcheck="false"
                                            min="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="tbr_radio_group">
                                        <div class="custom-control custom-radio custom-control-inline mb-0">
                                            @if (session('step3data')->buyer_gender)
                                                <input type="radio" id="male" name="buyer_gender" class="custom-control-input" value="Laki-laki" {{ session('step3data')->buyer_gender === "Laki-laki" ? "checked" : "" }}>
                                            @else
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline mb-0">
                                            @if (session('step3data')->buyer_gender)
                                                <input type="radio" id="female" name="buyer_gender" class="custom-control-input" value="Perempuan" {{ session('step3data')->buyer_gender === "Perempuan" ? "checked" : "" }}>
                                            @else
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        @foreach ($jobs as $job)
                                            @if (session('step3data')->buyer_job)
                                                <option value="{{ $job }}" {{ session('step3data')->buyer_job === $job ? "selected" : "" }}>{{ $job }}</option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group tbr_fix_ig">
                                        ...
                                        <input
                                            ...
                                            id="buyer_phone"
                                            name="buyer_phone"
                                            value="{{ session('step3data')->buyer_phone ?? auth()->guard('patient')->user()->phone_number }}"
                                            placeholder=""
                                            tabindex=""
                                            spellcheck="false"
                                            min="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group tbr_fix_ig">
                                        ...
                                        <input
                                            ...
                                            id="buyer_whatsapp"
                                            name="buyer_whatsapp"
                                            value="{{ session('step3data')->buyer_whatsapp ?? auth()->guard('patient')->user()->whatsapp_number }}"
                                            placeholder=""
                                            tabindex=""
                                            spellcheck="false"
                                            min="0"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="buyer_email"
                                        name="buyer_email"
                                        value="{{ session('step3data')->buyer_email ?? auth()->guard('patient')->user()->email }}"
                                        placeholder=""
                                        tabindex=""
                                        spellcheck="false"
                                    >
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        @foreach ($provinces as $province)
                                            @if (session('step3data')->buyer_province)
                                                <option value="{{ $province->name }}" {{ session('step3data')->buyer_province === $province->name ? "selected" : "" }}>{{ $province->name }}</option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        @foreach ($regencies as $regency)
                                            @if (session('step3data')->hasAttribute('buyer_regency'))
                                                <option value="{{ $regency->name }}" {{ session('step3data')->buyer_regency === $regency->name ? "selected" : "" }}>{{ $regency->name }}</option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        @foreach ($districts as $district)
                                            @if (session('step3data')->hasAttribute('buyer_district'))
                                                <option value="{{ $district->name }}" {{ session('step3data')->buyer_district === $district->name ? "selected" : "" }}>{{ $district->name }}</option>
                                            @else
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ session('step3data')->buyer_sub_district ?? auth()->guard('patient')->user()->village }}"
                                        placeholder=""
                                        tabindex=""
                                        spellcheck="false"
                                    >
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="buyer_address"
                                        name="buyer_address"
                                        value="{{ session('step3data')->buyer_address ?? auth()->guard('patient')->user()->address }}"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <textarea
                                        ...
                                        tabindex=""
                                        spellcheck="false"
                                    >{{ session('step3data')->buyer_symptoms }}</textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group pt-1">
                                    <div class="tbr_mega_radio tbr_mega_radio_inline">
                                        <div class="custom-control custom-radio d-flex mb-0">
                                            @if (session('step3data')->buyer_payment_method)
                                                <input type="radio" id="cash" name="buyer_payment_method" value="Cash" class="custom-control-input" {{ session('step3data')->buyer_payment_method === "Cash" ? "checked" : "" }}>
                                            @else
                                        ...
                                        <div class="custom-control custom-radio d-flex mb-0">
                                            @if (session('step3data')->buyer_payment_method)
                                                <input type="radio" id="transfer" name="buyer_payment_method" value="Transfer" class="custom-control-input" {{ session('step3data')->buyer_payment_method === "Transfer" ? "checked" : "" }}>
                                            @else
            ...
            <div class="row">
                <div class="col">
                    <div class="tbr_wizard_nav">
                        <a href="{{ route('order.step-2') }}" anim="ripple" class="btn tbr_btn-outline tbr_btn-o-primary tbr_wizard_prev">
...
@section('blockfoot')
    <script>
        ...
        const sessionDataUrl = "{{ route('order.step3data') }}";
    </script>
    <script src="{{ asset('assets/js/visitor/step3-province.js') }}"></script>
    <script src="{{ asset('assets/js/visitor/step3-regency.js') }}"></script>
    <script src="{{ asset('assets/js/visitor/step3-save-to-session.js') }}"></script>
    <script src="{{ asset('assets/js/visitor/step3-submit-patient-data.js') }}"></script>
@endsection
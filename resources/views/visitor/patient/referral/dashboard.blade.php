                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tbr_inline_content">
                            <dl class="row">
                                ...
                                <dd class="col-sm-9"><em>{{ $patient->name }}</em></dd>

                                <dt class="col-sm-3">Telepon</dt>
                                <dd class="col-sm-9"><em>62 {{ $patient->phone_number }}</em></dd>

                                <dt class="col-sm-3">WhatsApp</dt>
                                <dd class="col-sm-9"><em>62 {{ $patient->whatsapp_number }}</em></dd>

                                <dt class="col-sm-3">Email</dt>
                                <dd class="col-sm-9"><em>{{ $patient->email }}</em></dd>

                                <dt class="col-sm-3">Alamat</dt>
                                <dd class="col-sm-9"><em>{{ $patient->full_address }}</em></dd>
                            </dl>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="tbr_small_title mb-2">Nomor Rekening</div>
                        <form action="{{ route('patient.referral.updateAccount') }}" method="POST" class="main_form">
                            @csrf
                            <div class="form-group">
                                <input
                                    ...
                                    id="bank_name"
                                    name="bank_name"
                                    value="{{ $patient->referrer->bank_name }}"
                            ...
                            <div class="form-group">
                                <input
                                    ...
                                    id="bank_account"
                                    name="bank_account"
                                    value="{{ $patient->referrer->bank_account }}"
                            ...
                            <div class="form-group">
                                <input
                                    ...
                                    id="account_number"
                                    name="account_number"
                                    value="{{ $patient->referrer->account_number }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group tbr_ig-btn">
                                <input
                                    ...
                                    id="url"
                                    name="url"
                                    value="{{ route('referrer.code', $patient->referrer->unique_reff) }}"
                                    placeholder=""
                                    tabindex=""
                                    disabled
                                >
                                <div class="input-group-append">
                                    <button
                                        ...
                                        data-clipboard-text="{{ route('referrer.code', $patient->referrer->unique_reff) }}"
                                    >
...
@section('blockfoot')
	...
	<script>
        const referralUrl = "{{ route('patient.referral.dashboard') }}";
		const url = "{{ route('patient.referral.list') }}";
		const orderFalse = [];
